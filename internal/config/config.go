...
func Parse() (Config, error) {
	...
	fs.Var(&manual, "block-domain", "exact domain to block; may be specified more than once")
	fs.Var(&manualAllow, "allow-domain", "exact domain to allow even if it also appears in a block policy; may be specified more than once")
